...
Public beta `0.2.0-beta.2`. Linux/Omarchy first; macOS Intel and Apple silicon packages use the same commands. Windows has no installer yet.
...
```sh
curl -fsSL https://github.com/pedromst/notryn/releases/download/v0.2.0-beta.2/install.sh | sh
```
...
```sh
notryn update --version 0.2.0-beta.2
```
