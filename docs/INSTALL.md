...
Public beta `0.2.0-beta.11`. Linux/Omarchy first; macOS Intel and Apple silicon packages use the same commands. Windows has no installer yet.
...
```sh
notryn update --version 0.2.0-beta.11
```
