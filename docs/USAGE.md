...
- Quiet glass panels, a full-width immersive brain mode, optional motion and keyboard zoom. Themes include Glass, Daylight, Matrix, Jarvis, Command and Dusk; Jarvis turns the complete workspace into a cyan glass cockpit with clipped technical corners, layered depth and a restrained reactor dial, without changing the controls.
