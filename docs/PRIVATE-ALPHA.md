...
- `notryn` opens the desktop application.
- `notryn update` installs a verified newer package after the app is closed.
- `notryn rollback` restores a saved application version.
- `notryn uninstall` preserves notes, settings and recoverable app backups.
